...
resource "azurerm_network_security_group" "main" {
  ...
  security_rule {
    ...
    destination_port_ranges    = var.inbound_security_rule.dest_ports # List of ports to open. Restrict inbound traffic to target these ports. Source it the cient, dest is the server
