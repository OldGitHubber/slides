...
NIC_name = "ssl-demo" # Network interface card name
...
#============================================================================================
vm_spec = {
  name       = "ssl-demo"   # Cannot had _ in computer name
...
OS_image = {
  ...
  sku       = "20_04-lts-gen2" # Stock Keeping Unit is the Family name
...
push_images = ["oldgitdocker/ssl:latest"] # List as many images as you want

# Point ot the Docker installation script of your choice. Note use docker-az-tf-swap for small VM with database
docker_install_script = {
  source_dir = "C:\\Users\\tonyn\\OneDrive - UCLan\\CO3404\\Demos\\all_scripts"
...
copy_config = [
  ...
  # {
  #   source      = "../cert/cert.pem"
  #   destination = "/home/tony/.cert/cert.pem"
  # },
  #  {
  #   source      = "../cert/key.pem"
  #   destination = "/home/tony/.cert/key.pem"
  # }
]
