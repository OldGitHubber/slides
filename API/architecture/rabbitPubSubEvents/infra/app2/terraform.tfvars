...
publicIP = {
  ...
  sku  = "Standard"
  domain_name = "tnapp2" # Cannot be null. azure will create tnapp2.region.cloudapp.azure.com
}
...
push_images              = ["oldgitdocker/app2:latest"]
