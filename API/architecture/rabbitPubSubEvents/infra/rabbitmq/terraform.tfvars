...
publicIP = {
  ...
  sku  = "Standard"
  domain_name = "tnrabbitmq" # Cannot be null. azure will create tnrabbitmq.region.cloudapp.azure.com
}
...
inbound_security_rule = {
  name       = "all-app-ports"
  priority   = 1000
  dest_ports = ["22","5672", "15672"] 
}

ip_config_name = "rabbitmq"
...
push_images              = [] # No images to build or push as just using rabbitmq image pulled at remote