# Do this one first then others as they need this network to deploy into
# Main file to create a project wide virtual network and resource group
...
resource "azurerm_subnet" "subnet1" {
  ...
  resource_group_name  = var.resource_group_name           # Which resource group. AWS doesn't use RGs
...
# EOT or heredoc enables multiline output exactly as specifies and without ""
