...
publicIP = {
  ...
  sku  = "Standard"
  domain_name = "tnapp3" # Cannot be null. azure will create tnapp3.region.cloudapp.azure.com
}
...
push_images              = ["oldgitdocker/app3:latest"]
